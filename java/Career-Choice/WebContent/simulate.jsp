...
<body>
    ...
    <div class="form-wrapper simulate-wrapper">
        ...
        <form id="simulateForm" action="${pageContext.request.contextPath}/SimulateServlet" method="post" class="simulate-form" onsubmit="return validateForm()">
            <div class="form-grid">
    ...
    <script>
        function validateForm() {
            ...
            if (age < 19 || age > 60) {
                alert('만 19세 이상, 만 60세 이하만 시뮬레이션이 가능합니다.');
                return false;
            }
            
            // hidden age 필드에 계산된 나이 값 설정
        ...
        // 뒤로가기 등으로 페이지가 캐시에서 로드될 때 로딩 오버레이 숨기기
